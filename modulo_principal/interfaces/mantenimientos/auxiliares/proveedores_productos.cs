...
namespace interfaces.mantenimientos.auxiliares
{
    public partial class proveedores_productos : Form
    {
        ...
        private void proveedores_productos_Load(object sender, EventArgs e)
        {
            ...
            utilitarios.cargandoListas.cargarLista(conexiones_BD.clases.proveedores.datosTabla(false), listaProveedores, "nombre_proveedor", "idproveedor");
        ...
        {
            tabla = new utilitarios.cargar_tablas(tablaProveedores, new TextBox(), conexiones_BD.clases.proveedores_productos.datosTabla(idproducto, false), "nombre_proveedor");
