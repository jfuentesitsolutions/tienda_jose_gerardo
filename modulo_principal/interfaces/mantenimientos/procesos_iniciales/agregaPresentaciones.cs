...
namespace interfaces.mantenimientos.procesos_iniciales
{
    public partial class agregaPresentaciones : Form
    {
        ...
        {
            te.Text = "";
            tabla = new utilitarios.cargar_tablas(tabla_presentacion_producto,te, conexiones_BD.clases.presentaciones_productos.presentacionesXproducto(idsucursal_producto, false), "nombre_presentacion");
