    ...
    public partial class producto_unica_presentacion : Form
    {
        ...
        private void cargarListas()
        {
            if (modificar)
            {
                ...
                cargandoListas.cargarLista(utilidades.datosTablaDetalle(false), listaUDetalle, "nombre", "idutilidad_compra");
                listaUDetalle.SelectedValue = Idud;
                cargandoListas.cargarLista(utilidades.datosTablaMayoreo(false), listaUMayoreo, "nombre", "idutilidad_compra");
        ...
        private void cargarTablas()
        {
            ...
            {
                DataTable pro_pre = presentaciones_productos.presentacionesXproducto(idsp, false);
