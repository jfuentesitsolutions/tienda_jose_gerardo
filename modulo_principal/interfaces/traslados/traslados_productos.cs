...
namespace interfaces.traslados
{
    public partial class traslados_productos : Form
    {
        ...
        {
            utilitarios.cargandoListas.cargarLista(conexiones_BD.clases.sucursales.datosTabla(false), listaSucurSalida, "numero_de_sucursal", "idsucursal");
            listaSucurSalida.SelectedValue = sesion.DatosRegistro[1];
            utilitarios.cargandoListas.cargarLista(conexiones_BD.clases.sucursales.datosTabla(false), listaSucurLlegada, "numero_de_sucursal", "idsucursal");
