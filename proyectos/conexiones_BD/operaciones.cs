...
namespace conexiones_BD
{
    public class operaciones : Conexion
    {
        ...
        private bool tipo_conexion()
        {
            bool conectado = false;
            if (!Conexion_remota)
            {
                conectado = base.conectar();
            }
            else
            {
                conectado = base.conectar_remota();
            }
        ...
        public String obtenerIp()
        {
            ...
            if (tipo_conexion())
            {
                ip = obtenerIpservidor();
                desconectar();
                return ip;
            }
            else
            {
                ip = "No hay conexion al servidor";
                desconectar();
                return ip;
            }
        }
