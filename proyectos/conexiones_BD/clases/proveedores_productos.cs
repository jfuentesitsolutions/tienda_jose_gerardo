...
namespace conexiones_BD.clases
{
    public class proveedores_productos:entidad
    {
        ...
        public string Idproveedor_producto { get => idproveedor_producto; set => idproveedor_producto = value; }
        ...
        public static DataTable datosTabla(string idpro, bool cr)
        {
        ...
        {
            string sentencia = "UPDATE proveedores_productos SET idproveedor = '"+idproveedor+"' WHERE (idproveedor_producto = '"+Idproveedor_producto+"');";
            return sentencia;
        }
    }
}
