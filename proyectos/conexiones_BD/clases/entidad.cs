...
namespace conexiones_BD.clases
{
    public class entidad
    {
        ...
        public virtual long guardar(bool mensaje, bool cr)
        {
            long id_guardado = 0;
        ...
        public virtual Int32 eliminar(bool mensaje, bool cr)
        {
            Int32 eliminado = 0;
        ...
        public virtual Int32 validarCamposcondicorAND(bool mensaje, bool cr)
        {
            Int32 valido = 0;
        ...
        public virtual Int32 validarCamposcondicorANDActu(bool mensaje, int limite_resul, bool cr)
        {
            Int32 valido = 0;
