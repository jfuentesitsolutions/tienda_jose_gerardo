...
namespace conexiones_BD.clases.compras
{
    ...
    {
        string iddetalle_compra, idsucursal_producto, cantidad, precio_compra_m, 
            precio_compra_d, total, porcentaje_utilidad_M, porcentaje_utilidad_D, 
            idfactura_compra, idutilidadMayoreo, idutilidadDetalle, precio_venta_m, 
            precio_venta_d, cantidad_paquete, presentacion_producto, iva;
        ...
        public detalles_compras(string idsucursal_producto, 
            ...
            string cantidad_paquete, string presentacion_producto, string iva)
        {
