...
namespace conexiones_BD.clases.compras
{
    public class facturas_compras:entidad
    {
        ...
        public facturas_compras(string numero_factura, string idtipofactura, string idusuario, 
            string monto_total_neto, string descuento_iva, string descuento_renta, string monto_total, 
            string fecha_factura, string idproveedor)
        {
